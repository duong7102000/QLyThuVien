...
public class loginRFID extends JFrame {
...
/**
    ...
    private void initComponents() {
        ...
        jPanel1 = new JPanel();
        logoHeader_Label = new JLabel();
        logoMain_Label = new JLabel();
        //loadingIcon_Label = new javax.swing.JLabel();
        WareIcon_Label = new JLabel();
        exit_btn = new JLabel();
        movingWindow_Label = new JLabel();
        loginGUI_Label = new JLabel();
        ...
        logoHeader_Label.setIcon(new ImageIcon(getClass().getResource("../images/icon_Header_100_100.png"))); // NOI18N
        logoHeader_Label.setBounds(100, 70, 100, 100); // NOI18N
        jPanel1.add(logoHeader_Label);

        logoMain_Label.setIcon(new ImageIcon(getClass().getResource("../images/icon_main_80_80.png"))); // NOI18N
...
/** not working with Serial Connection
        ...
        **//*
        ...
        WareIcon_Label.setIcon(new ImageIcon(getClass().getResource("../images/ware_icon_220_220.png"))); // NOI18N
        WareIcon_Label.setBounds(42, 172, 220, 220); // NOI18N
        jPanel1.add(WareIcon_Label);

        exit_btn.setIcon(new ImageIcon(getClass().getResource("../images/exit_btn_30_30.png"))); // NOI18N
        ...
        loginGUI_Label.setIcon(new ImageIcon(getClass().getResource("../images/login_RFID_300_492.png"))); // NOI18N
...
/** testing part
    ...
    private JLabel WareIcon_Label;
    private JLabel loginGUI_Label;
    private JLabel logoHeader_Label;
    private JLabel logoMain_Label;
