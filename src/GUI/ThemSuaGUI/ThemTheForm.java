...
public class ThemTheForm extends JFrame{
    ...
    private void initComponents() {
        ...
        ngayCap_Label = new JLabel();
        maKH_Label = new JTextField();
        ...
        ngayCap_Label.setBackground(new Color(245, 247, 250));
        ngayCap_Label.setFont(new Font("Tahoma", 0, 14)); // NOI18N
        ...
        nhanVienForm.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtoolsthemthe.png"))); // NOI18N
