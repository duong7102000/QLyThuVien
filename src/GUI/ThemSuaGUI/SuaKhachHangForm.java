...
public class SuaKhachHangForm extends JFrame{
    ...
    public SuaKhachHangForm(String maKH) {
        ...
        mkh = maKH;
        initComponents(kh.getHoTen(), kh.getNgaySinh(), kh.getSdt(), kh.getEmail(), kh.getDiaChi());
        setSize(830, 336);
    ...
    private void initComponents(String hoTen, String ngaySinh, String sdt, String email, String diaChi) {
        ...
        nhanVienForm.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtoolssuakh.png"))); // NOI18N
    ...
    private void addButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_addButtonMouseClicked
        ...
        if (check_input(hoTen, ngaySinh, sdt, email, diaChi)){
            int option = JOptionPane.showConfirmDialog(
                null, 
                "Bạn có muốn sửa Khách Hàng" + hoTen + " ?", 
                "Xóa Khách Hàng", 
