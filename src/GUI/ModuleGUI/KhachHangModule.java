...
public class KhachHangModule {
    ...
    private void initComponents() {
        ...
        checkbox = new ComboCheckBox(new ArrayList<String>(Arrays.asList(khachHangBUS.getHeaders())));
...
//        cb.setLocation(150, 115);
    ...
    private void searchtextfieldKeyReleased(java.awt.event.KeyEvent evt) {
        ...
        //ArrayList <QLKhachHangDTO> loaiSach = khachHangBUS.search_all(search_str);
        ...
        ArrayList <QLKhachHangDTO> search_temp = new ArrayList<>();
        for (String e : columns_checked){
            search_temp = khachHangBUS.search(e, search_str);

            ArrayList <String> pkey_1 = new ArrayList<>();
            ArrayList <String> pKey_2 = new ArrayList<>();

            for (QLKhachHangDTO ele : search_res){
                pkey_1.add(ele.getMaKhachHang());
            }

            for (QLKhachHangDTO ele : search_temp){
                pKey_2.add(ele.getMaKhachHang());
            }

            search_res = khachHangBUS.getKhachHang_full(new DataProcessing().union_arr(pkey_1, pKey_2));
        }
