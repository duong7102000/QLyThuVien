...
public class ThongKeModule_PhieuMuon {
    ...
    public JPanel getTrangChuGUI() {
        ...
        report.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools - 2020-06-12T133359.638.png"))); // NOI18N
        ...
        chart_t_2.getTitle().setFont(new Font("Arial", 1, 16));
