...
public class Sach_SelectionModule{
    ...
    private void initComponents() {
        ...
        jPanel1 = new JPanel();
        tittle_LoaiSach = new JLabel();
        tittle_SachThuVien = new JLabel();
        tittle_SachMuon = new JLabel();
        choice_SachMuon = new JLabel();
        choice_SachThuVien = new JLabel();
        choice_LoaiSach = new JLabel();
        ...
        choice_SachMuon.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools - 2020-05-28T172343.540.png"))); // NOI18N
        ...
        choice_SachThuVien.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools (98).png"))); // NOI18N
        ...
        choice_LoaiSach.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools (97).png"))); // NOI18N
    ...
    private void choice_LoaiSachMouseMoved(java.awt.event.MouseEvent evt) {
        choice_LoaiSach.setBorder(BorderFactory.createLineBorder(new java.awt.Color(102,255,255), 2));
    }
    ...
    private void choice_SachThuVienMouseMoved(java.awt.event.MouseEvent evt) {
        choice_SachThuVien.setBorder(BorderFactory.createLineBorder(new java.awt.Color(102,255,255), 2));
    }
    ...
    private void choice_SachMuonMouseMoved(java.awt.event.MouseEvent evt) {
        choice_SachMuon.setBorder(BorderFactory.createLineBorder(new java.awt.Color(102,255,255), 2));
    }
    ...
    private JLabel choice_LoaiSach;
    private JLabel choice_SachMuon;
    private JLabel choice_SachThuVien;
    private JPanel jPanel1;
    private JLabel tittle_LoaiSach;
    private JLabel tittle_SachMuon;
    private JLabel tittle_SachThuVien;
