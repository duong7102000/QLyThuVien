...
public class PhieuPhatModule {
    ...
    private void initComponents() {
        ...
        ldPhat_btn.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools - 2020-06-17T221434.044.png"))); // NOI18N
...
//        }
    ...
    private void ldPhat_btnMouseEntered(java.awt.event.MouseEvent evt){
        ldPhat_btn.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools - 2020-06-17T221444.592.png"))); // NOI18N
    ...
    private static JPanel phieuPhat_Table;
    private static JLabel refresh_btn;
    private static JLabel expand_btn;
    private static JLabel ldPhat_btn;
