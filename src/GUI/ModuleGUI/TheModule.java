...
public class TheModule {
    ...
    private void initComponents() {
        ...
        checkbox = new ComboCheckBox(new ArrayList<String>(Arrays.asList(new QLTheBUS().getHeaders())));
...
//        cb.setLocation(150, 115);
    ...
    private void searchtextfieldKeyReleased(java.awt.event.KeyEvent evt) {
        ...
        //ArrayList <QLTheDTO> loaiSach = theBUS.search_all(search_str);
        ...
        ArrayList <QLTheDTO> search_temp = new ArrayList<>();
        for (String e : columns_checked){
            search_temp = new QLTheBUS(0).search(e, search_str);

            ArrayList <String> pkey_1 = new ArrayList<>();
            ArrayList <String> pKey_2 = new ArrayList<>();

            for (QLTheDTO ele : search_res){
                pkey_1.add(ele.getMaThe());
            }

            for (QLTheDTO ele : search_temp){
                pKey_2.add(ele.getMaThe());
            }

            search_res = new QLTheBUS(0).getThe_full(new DataProcessing().union_arr(pkey_1, pKey_2));
        }
