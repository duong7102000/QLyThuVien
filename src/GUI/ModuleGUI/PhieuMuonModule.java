...
public class PhieuMuonModule {
    ...
    private void initComponents() {
        ...
        phieuPhat_btn.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools - 2020-06-17T210344.296.png"))); // NOI18N
...
//        cb.setLocation(150, 115);
    ...
    private void phieuPhat_btnMouseEntered(java.awt.event.MouseEvent evt){
        phieuPhat_btn.setIcon(new ImageIcon(getClass().getResource("../../images/output-onlinepngtools - 2020-06-17T210351.501.png"))); // NOI18N
    ...
    private static JPanel phieuMuon_Table;
    private static JLabel refresh_btn;
    private static JLabel expand_btn;
    private static JLabel phieuPhat_btn;
