...
public class LoginGUI extends JFrame{
    ...
    private void initComponents() {
        ...
        RFIDLogin = new JLabel();
        exit_btn = new JPanel();
        login_form = new JLabel();
        ...
        // *** jLabel_username *** //
        jLabel_username.setBackground(new Color(91, 231, 196));
        jLabel_username.setFont(new Font("Ubuntu", 0, 18)); // NOI18N
        jLabel_username.setForeground(new Color(245, 247, 250));
        jLabel_username.setText("Username");
        jLabel_username.setMaximumSize(new Dimension(83, 21));
        jLabel_username.setMinimumSize(new Dimension(83, 21));
        jLabel_username.setPreferredSize(new Dimension(83, 21));
        ...
        // *** jLabel_password *** //
        jLabel_password.setBackground(new Color(91, 231, 196));
        jLabel_password.setFont(new Font("Ubuntu", 0, 18)); // NOI18N
        jLabel_password.setForeground(new Color(245, 247, 250));
        jLabel_password.setText("Password");
        jLabel_password.setMaximumSize(new Dimension(83, 21));
        jLabel_password.setMinimumSize(new Dimension(83, 21));
        jLabel_password.setPreferredSize(new Dimension(83, 21));
        ...
        // *** username_field *** //
        username_field.setBackground(new Color(91, 231, 196));
        username_field.setFont(new Font("Ubuntu", 0, 18)); // NOI18N
        username_field.setForeground(new Color(245, 247, 250));
        username_field.setBorder(null);
        username_field.setOpaque(false);
        username_field.setPreferredSize(new Dimension(83, 21));
        ...
        // *** password_field *** //
        password_field.setBackground(new Color(91, 231, 196));
        password_field.setFont(new Font("Ubuntu", 0, 18)); // NOI18N
        password_field.setForeground(new Color(245, 247, 250));
        password_field.setBorder(null);
        password_field.setOpaque(false);
        password_field.setPreferredSize(new Dimension(80, 21));
        ...
        GroupLayout exit_btnLayout = new GroupLayout(exit_btn);
        exit_btn.setLayout(exit_btnLayout);
        exit_btn.setBounds(470, 20, 30, 30);
        exit_btnLayout.setHorizontalGroup(
            exit_btnLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
        ...
        /** RFID login **/
        RFIDLogin.setIcon(new ImageIcon(getClass().getResource("../images/icon_RFIDLogin_30_30.png"))); // NOI18N
        ...
        login_form.setIcon(new ImageIcon(getClass().getResource("../images/login.png"))); // NOI18N
    ...
    private void username_fieldKeyPressed(KeyEvent evt) {
    ...
    private void password_fieldKeyPressed(KeyEvent evt) {
        if (evt.getKeyCode() == KeyEvent.VK_ENTER){
            System.out.println("Đăng Nhập" + "\t username: " + username_field.getText() + "\t password: " + password_field.getText());
            DangNhap();
        }
